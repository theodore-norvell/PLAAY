...
describe( 'StringLiteralLabel', function() {
    ...
    it('should evaluate to a StringV', function() {
        ...
        assert.check( (<StringV>val).getVal() === label.getVal() ) ;
    } );
} ) ;

describe( 'NumberLiteralLabel', function() {
...
describe( 'BooleanLiteralLabel', function() {
...
describe( 'NullLiteralLabel', function() {
    const label = new labels.NullLiteralLabel() ;
    const root = new PNode( label, [] ) ;
    const vm = new VMS( root, wlds, interp ) ;

    it('should evaluate to a NullV', function() {
        assert.check( ! vm.isReady() ) ;
        vm.advance() ;
        assert.check( vm.isReady() ) ;
        vm.advance() ;
